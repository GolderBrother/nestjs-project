...
import { ChatHistoryService, HistoryDto } from './chat-history.service';
...
export class ChatHistoryController {
  ...
  async add(
    ...
    @Body('history') history: HistoryDto,
  ) {
    return await this.chatHistoryService.add(+chatroomId, history);
  }
